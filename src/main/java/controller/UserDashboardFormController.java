...
public class UserDashboardFormController {
    ...
    public void setData(String nic) throws WriterException {
        ...
        lblQuota.setText(String.valueOf(user.getQuota()) + " L");
    ...
    public void btnDownload_OnAction(ActionEvent actionEvent) throws IOException {
        ...
        File file = new File(System.getenv("HOME")); // Or System.getProperty("user.home")
        ...
        if (saveLocation != null) {
            //System.out.println(saveLocation);   // Save location file.
